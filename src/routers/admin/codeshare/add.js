...
console.log('[allenbots]: Admin/CodeShare/Add router loaded.');
	...
	client.channels.cache
		...
		.send(
			new Discord.MessageEmbed()
				...
				.setDescription(
					`The user named **[${req.user.username}](https://allenbots.tk/user/${req.user.id})** added the code named **${rBody['codename']}** to the system.`
				)
				.addField('Code Link', `https://allenbots.tk/code/${kod}`, true)
