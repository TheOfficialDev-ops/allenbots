...
console.log('[allenbots]: Admin/CodeShare/Delete router loaded.');
	...
	client.channels.cache
		...
		.send(
			new Discord.MessageEmbed()
				...
				.setDescription(
					`The user named **[${req.user.username}](https://allenbots.tk/user/${req.user.id})** deleted the code named **${kodDataFind.codeName}**.`
				)
